...
df_zuerich_cleaned <- df_zuerich_cleanead %>%
...
write.csv(df_vaud_cleanead, "df_vaud_cleaned.csv", row.names = FALSE)
write.csv(df_geneva_cleanead, "df_geneva_cleaned.csv", row.names = FALSE)
