...
```{r}
# Funktion zur Erstellung eines Streudiagramms mit Regressionslinie für mehrere Variablen
plot_multiple_regressions <- function(data, x_vars, y_var, title) {
...
plot_multiple_regressions(df_zuerich_cleaned, rating_vars, "price_per_person", "Zürich - Bewertungen")

# Plot für Gastgeber in Zürich
plot_multiple_regressions(df_zuerich_cleaned, host_vars, "price_per_person", "Zürich - Gastgeber")

# Plot für Lage in Zürich
plot_multiple_regressions(df_zuerich_cleaned, location_vars, "price_per_person", "Zürich - Lage")

# Plot für Bewertungen in Vaud
plot_multiple_regressions(df_vaud_cleaned, rating_vars, "price_per_person", "Vaud - Bewertungen")

# Plot für Gastgeber in Vaud
plot_multiple_regressions(df_vaud_cleaned, host_vars, "price_per_person", "Vaud - Gastgeber")

# Plot für Lage in Vaud
plot_multiple_regressions(df_vaud_cleaned, location_vars, "price_per_person", "Vaud - Lage")

# Plot für Bewertungen in Geneva
plot_multiple_regressions(df_geneva_cleaned, rating_vars, "price_per_person", "Geneva - Bewertungen")

# Plot für Gastgeber in Geneva
plot_multiple_regressions(df_geneva_cleaned, host_vars, "price_per_person", "Geneva - Gastgeber")

# Plot für Lage in Geneva
plot_multiple_regressions(df_geneva_cleaned, location_vars, "price_per_person", "Geneva - Lage")
